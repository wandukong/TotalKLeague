...
public class Plan11Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_plan11, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        planList = db.planDao().getPlan("11");

        recyclerView = view.findViewById(R.id.recyclerView_plan11);
